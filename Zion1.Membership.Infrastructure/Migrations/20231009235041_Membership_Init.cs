    ...
    public partial class Membership_Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MembersInGroups", x => new { x.GroupsId, x.MembersId });
                    table.ForeignKey(
                        name: "FK_MembersInGroups_Groups_GroupsId",
                        column: x => x.GroupsId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MembersInGroups_Members_MembersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembersInGroups_MembersId",
